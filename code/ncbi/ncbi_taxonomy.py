...
# Fabaceae: 3803, Fabales: 72025, fabids: 91835, rosids: 71275
...
def get_group_tree(group, rank):
	...
	group_id = ncbi.get_name_translator([group])[group]
...
def get_species_by_rank(tree, group, rank):
...
if __name__ == "__main__":
	...
	#get the group tree
	tree = get_group_tree(tree, group, rank)	
